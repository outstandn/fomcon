...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox_2.setTitle(_translate("Dialog", "Simulation Parameter"))
        self.label.setText(_translate("Dialog", "Method:"))
        self.label_2.setText(_translate("Dialog", "w range:"))
        self.lineEdit_StartFreq.setText(_translate("Dialog", "0.0001"))
        self.lineEdit_StartFreq.setPlaceholderText(_translate("Dialog", "Start (float)"))
        self.lineEdit_StopFreq.setText(_translate("Dialog", "10000"))
        self.lineEdit_StopFreq.setPlaceholderText(_translate("Dialog", "Stop (int)"))
        self.label_3.setText(_translate("Dialog", "Order:"))
        self.lineEdit_5.setText(_translate("Dialog", "10"))
        self.lineEdit_5.setPlaceholderText(_translate("Dialog", "(int)"))
        self.groupBox_7.setTitle(_translate("Dialog", "Identification and Options"))
        self.groupBox_5.setTitle(_translate("Dialog", "Source Data"))
        self.label_4.setText(_translate("Dialog", "DATA Objects:"))
        self.pushButton_8.setText(_translate("Dialog", "Refresh"))
        self.label_5.setText(_translate("Dialog", "Algorithm:      "))
        self.label_6.setText(_translate("Dialog", "Lamda:"))
        self.lineEdit_7.setText(_translate("Dialog", "0.01"))
        self.groupBox_6.setTitle(_translate("Dialog", "Identified Model"))
        self.checkBoxNumerator.setText(_translate("Dialog", "fix"))
        self.plainTextEdit_Zeros.setStatusTip(_translate("Dialog", "0"))
        self.plainTextEdit_Zeros.setPlaceholderText(_translate("Dialog", "Zeros"))
        self.checkBox_Denominator.setText(_translate("Dialog", "fix"))
        self.plainTextEdit_Poles.setPlaceholderText(_translate("Dialog", "Poles"))
        self.checkBox_Denominator_2.setText(_translate("Dialog", "delay [s] :"))
        self.lineEdit_Delay.setText(_translate("Dialog", "0"))
        self.lineEdit_Delay.setPlaceholderText(_translate("Dialog", "int [s]"))
        self.groupBoxInitialGuess.setTitle(_translate("Dialog", "Generate Initial Guess Model"))
        self.label_8.setText(_translate("Dialog", "q[0.01:2):"))
        ...
        self.checkBox_Denominator_3.setText(_translate("Dialog", "Co-efficients"))
        self.label_9.setText(_translate("Dialog", "Minimum:"))
        self.lineEdit_8.setText(_translate("Dialog", "4"))
        self.label_13.setText(_translate("Dialog", "Maximum:"))
        self.lineEdit_9.setText(_translate("Dialog", "4"))
        self.checkBox_Denominator_4.setText(_translate("Dialog", "Exponents"))
        self.label_10.setText(_translate("Dialog", "Minimum:"))
        self.lineEdit_11.setText(_translate("Dialog", "4"))
        self.label_12.setText(_translate("Dialog", "Maximum:"))
        self.lineEdit_10.setText(_translate("Dialog", "4"))
        self.pushButton_10.setText(_translate("Dialog", "Identify"))
